...
import com.smart.common.VerificationSign;
...
//    private UriInfo context;
    ...
    public String ReviveSignOn(String param) {
        ...
        try {
            ...
            if (!com.smart.common.VerificationSign.verificationSignUser(stmt, signModel.name, signModel.pwd)) {
                //登录用户名或密码有误
...
//                strTokenTemp = EncryptToken.EncryptLoginToken(sbTemp.toString());
            ...
            com.smart.common.RSLogger.ErrorLogInfo("ReviveSignOn error." + ex.getLocalizedMessage());
            ...
            com.smart.common.UtileSmart.FreeObjects(signModel, strTempSql);
        }
    ...
    public String ReviveSignOff(String param) {
        ...
        try {
            ...
            com.smart.common.RSLogger.ErrorLogInfo("ReviveSignOff error." + ex.getLocalizedMessage());
            return formationResult.formationResult(ResponseResultCode.Error, new ExecuteResultParam(ex.getLocalizedMessage(), param,ex));
        } finally {
            DBHelper.CloseConnection(stmt, conn);
            com.smart.common.UtileSmart.FreeObjects(signModel);
        }
    }
